...
class User_Data{
    ...
    private $username = "ia_user"; // Adjust the username to the username of the server before deployment
    private $password = ""; // Adjust the password to the password of the server before deployment
    private $database = "iinfinity_ai";
